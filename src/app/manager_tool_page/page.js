...
const ManagerToolsPage = () => {
  ...
  const menuItems = [
    {
      title: 'Manager Hub',
      description: 'Your command center. From team updates to training modules and daily operations, everything you need to lead effectively is here.',
      icon: (
    ...
    },
    {
      ...
      description: 'Track daily and shift-specific manager responsibilities like checklists, approvals, and operational follow-ups.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: 'Incident Log',
      description: 'Record guest complaints, accidents, and maintenance issues in real time for better reporting and accountability.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  // Manager Hub card ko menuItems array se alag kar lete hain
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 p-4 md:p-6 overflow-y-auto mt-20 md:mt-0">
         {/* Desktop Main Title with Icon */}
        <div className="hidden md:flex flex-row items-center text-white mb-6 p-6 rounded-3xl backdrop-blur-lg shadow-xl"
            style={{
        ...
        {/* Manager Hub - Full Width Card */}
        <div
          className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-xl p-7 flex items-start transition-all duration-300 hover:scale-[1.01] hover:shadow-2xl border border-white/50 mb-6"
        >
          ...
          {otherItems.map((item, index) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                {item.link && (
                  <a href={item.link} target="_blank" rel="noopener noreferrer" className="mt-2 flex items-center text-xs font-semibold hover:underline" style={{ color: themeColors.darkGreen }}>
